...
import {
  ...
  BottomPanel,
  ChartFooter
} from '../chartiq/components/Layout';

import { WrappedChart, Plugins } from '../chartiq/components/Core';
import ColorPicker from '../chartiq/components/Features/ColorPicker';
import ChartDialogs from '../chartiq/components/Dialogs/ChartDialogs';
import ScriptIQ from '../chartiq/components/Plugins/ScriptIQ/ScriptIQ';
import MarketDepthBookmark from '../chartiq/components/Plugins/CryptoIQ/MarketDepthBookmark';

import { ChartContext } from '../chartiq/context/ChartContext';
import { getDefaultConfig } from '../chartiq/_config';
import { ShareChart, RangeBar } from '../chartiq/components/Features';
...
class AdvancedChart extends React.Component {
  ...
  configureLoadedPlugins() {
    ...
    if (
      ...
      new CIQ.TimeSpanEventPanel({ stx, context: UIContext });
  ...
  resizeScreen() {
    ...
    const chartAreaRight = (SidePanelLoaded && SidePanelLoaded.nonAnimatedWidth()) || 0;
