...
export function getDefaultConfig() {
  return {
    ...
    quoteFeedBehavior: {
      refreshInterval: 10, // defaults to 1 if not set. Referesh interval is required for MarketDepth simulation
      bufferSize: 200,
    },
    ...
    breakpoints: [360, 760, 1340],              // breakpoints define changes in layout  original values: 584, 700
    ...
    footerRange: [
      ...
      { label: '5D', multiplier: 5, base: 'day', interval: 5, period: 1, timeUnit: 'minute', available: 'always' },
    ...
    plugins: {
      ...
      cryptoiq: {
        ...
        simulateL2(stx) {
          if (!CIQ.simulateL2) {
            console.error('Error: L2 simulation not available');
            return;
          }
